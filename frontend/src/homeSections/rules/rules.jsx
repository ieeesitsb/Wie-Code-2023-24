        ...
        <div className='rules-mini-container'>
            ...
            <div className="rules-content">
                <ul className='rules-ul'>
                    ...
                    <li>
                        Online registrations will be closed on 15th January 2023.
                    </li>
                    <li>
                    ...
                    <li>
                    An abstract in the format specified (https://bit.ly/3CNP19b) should be submitted by the team.
                    </li>
                    <li>
                    ...
                    <li>
                    We would consider the first 6 entries for each problem statements for the first round of screening. The WIE Code will begin on 21st January
                    2023 8:00 AM and will end at 21st January 2023 8:00 PM. Internet facility will be provided for 12 hours.
                    </li>
                    <li>
